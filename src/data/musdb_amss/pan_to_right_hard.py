...
class Musdb_Pan2Right_Hard(Selective_Audio_Editing):
    ...
    def __init__(self, target_names):
        ...
        self.descriptions = ['pan {} completely to the right side'.format(', '.join(d)) for d in target_permute]
    ...
    def edit(self, unmixed_track):
        ...
        for idx in self.targets_index:
            ...
            manipulated_track[idx, :, 1] = mean * 1.0
            manipulated_track[idx, :, 0] = mean * 0.0
    ...
    def edit_for_test(self, unmixed_track):
        ...
        for idx in range(4):
            if idx in self.targets_index:
                ...
                manipulated_not4return[idx, :, 1] = mean * 1.0
                manipulated_not4return[idx, :, 0] = mean * 0.0
...
def amss_pan2right_hard_generator():
    amss_pan2right_set = []
    for i in [1, 2, 3]:
        for comb in combinations(targets, i):
            amss_pan2right_set.append(Musdb_Pan2Right_Hard(comb))

    return amss_pan2right_set
